...
BifurcationVector = [1 1];  %A 1,0 array of which fp should be preserved.
...
N1 = 11; %Number of steps to do the initial continuation
N2 = 11; %Number of steps to do teh adaptive continuation of. 
