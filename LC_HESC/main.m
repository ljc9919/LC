...
LC_Parameters.ub = 2*ones(1, 11); %Bound parameter can be included to to maintain physiologically realistic parameter values. 
LC_Parameters.lb = 0*ones(1, 11); %lower bound for the parameters. 
%These bounds can be modified to achieve better convergence.


LC_Parameters.InitParams = ones(1, 11); %The initial parameter set for the model. 
